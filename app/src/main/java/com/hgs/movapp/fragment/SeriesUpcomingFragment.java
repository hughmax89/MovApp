...
public class SeriesUpcomingFragment extends BaseFragment implements SeriesContract.View, HasComponent<SeriesComponent> {
                ...
                new RecyclerTouchListener(getActivity(), recyclerView, new RecyclerTouchListener.ClickListener() {
                    ...
                    public void onClick(View view, int position) {
                        ...
                        getActivity().getSupportFragmentManager().beginTransaction()
                                .replace(R.id.container_series, fragment)
                                .commit();
                    }
